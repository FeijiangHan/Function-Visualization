export default function create_grid_tree_new(d3,data,place){
  document.querySelector(place).innerHTML = '';
  var config = {
      margins: {top: 20, left: 20, bottom: 40, right: 40},
      textColor: '#303133',
      cellWidth: 30,
      cellHeight: 30,
      cellmaxLevel:5,
...
var height = 2000;	//SVG绘制区域的高度

var svg = d3.select(place)			//选择<body>
